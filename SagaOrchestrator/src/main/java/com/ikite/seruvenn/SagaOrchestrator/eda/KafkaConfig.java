package com.ikite.seruvenn.SagaOrchestrator.eda;
...
//		props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, env.getProperty(CommonConstants.KAFKA_KEY_DESERIALIZER));
//		props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, env.getProperty(CommonConstants.KAFKA_VALUE_DESERIALIZER));
